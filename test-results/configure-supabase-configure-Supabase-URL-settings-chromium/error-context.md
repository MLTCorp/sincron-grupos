  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e20]:
      ...
      - complementary [ref=e84]:
        - generic [ref=e85]:
          - generic [ref=e86]: “
          - blockquote [ref=e87]: Very impressed by @supabase's growth. For new startups, they seem to have gone from "promising" to "standard" in remarkably short order.
          - link "patrickc @patrickc" [ref=e88] [cursor=pointer]:
            - /url: https://x.com/patrickc/status/1979157875600617913
            - img "patrickc" [ref=e89]
            - generic [ref=e91]: "@patrickc"
  - alert [ref=e92]
```